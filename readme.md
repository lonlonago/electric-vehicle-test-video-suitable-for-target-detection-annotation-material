# Electric vehicle test video suitable for target detection annotation material

# Body

Electric vehicle test video, suitable for target detection annotation materials
to the cloud link upon purchase, convenient for download.
For those in need, simply shoot and I'll send you the link directly
